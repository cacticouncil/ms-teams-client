...
> Each table is sorted by HTTP protocol ([**GET**](#get), [**POST**](#post), [**PUT**](#put), **DELETE**, **PATCH**).
...
| Host                                    | Endpoint                           | Description          | Authentication                                   |
| --------------------------------------- | ---------------------------------- | -------------------- | ------------------------------------------------ |
| https://amer.ng.msg.teams.microsoft.com | `/v2/users/ME/endpoints/${uuid()}` | Get endpoint to poll | `skypeToken=${credentials.authSkype.skypeToken}` |
